...
// assets
import UploadCover from 'assets/upload.svg';
    ...
    <>
      {type !== DropzopType.standard && (
        <Stack
          ...
          sx={{ width: 1, textAlign: { xs: 'center', md: 'left' }, p: 3 }}
        >
          <CardMedia component="img" image={UploadCover} sx={{ width: '100%', maxWidth: 150 }} />
          <Stack sx={{ p: 3, pl: 0 }} spacing={1}>
